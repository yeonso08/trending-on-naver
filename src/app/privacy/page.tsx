...
export default function PrivacyPage() {
  return (
    <Prose>
      ...
      <h2>1. 수집하는 정보</h2>
      <p>
        서비스는 회원가입 절차가 없으며 이름, 연락처, 주소 등 이용자를 직접 식별할 수 있는 정보를 수집하지
        않습니다. 다만 서비스 개선을 위해 다음과 같은 정보가 자동으로 수집될 수 있습니다.
      </p>
      <ul>
      ...
      <h2>2. 이용 목적</h2>
      <p>
        수집된 정보는 통계 분석을 통한 서비스 개선, 오류 진단, 페이지 성능 측정 목적으로만 이용합니다.
      </p>

      <h2>3. 쿠키와 광고</h2>
      <p>
        서비스는 Google AdSense를 통해 광고를 게재할 수 있습니다. Google을 포함한 제3자 광고 사업자는
      ...
      <h2>5. 보유 및 파기</h2>
      <p>
        서비스는 이용자를 식별할 수 있는 개인정보를 직접 저장하지 않습니다. 위 외부 서비스가 수집하는
        정보의 보유 기간은 각 사업자의 정책을 따릅니다.
      </p>
